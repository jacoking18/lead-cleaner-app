...
def process_csv(uploaded_file):
    ...
    df["Business Address"] = df.get("Address", "").fillna("") + ", " + df.get("City", "").fillna("") + ", " + df.get("State", "").fillna("") + " " + df.get("Zip", "").fillna("")
    df["Home Address"] = df.get("Owner Address", "").fillna("") + ", " + df.get("Owner City", "").fillna("") + ", " + df.get("Owner State", "").fillna("") + " " + df.get("Owner Zip", "").fillna("")
